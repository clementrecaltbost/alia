...
export default function Login() {
  return (
    <div className="bg-neutral-100 relative size-full" data-name="Login" data-node-id="341:3666">
      {/* Sidenav - Left Column */}
      <SideNav />

      {/* Container - Right Column with Login Form */}
      <div className="absolute backdrop-blur-[44px] backdrop-filter border border-[rgba(255,255,255,0.3)] border-solid h-[714px] left-[calc(50%+386px)] overflow-clip rounded-[24px] top-1/2 translate-x-[-50%] translate-y-[-50%] w-[620px]" data-name="Container" data-node-id="341:3675">
        ...
        <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-1/2 top-[179px] translate-x-[-50%] w-[426px]" data-name="Form title" data-node-id="341:3677">
          <p className="font-semibold leading-[1.4] not-italic relative shrink-0 text-[#1a1a1a] text-[23px] text-center w-full whitespace-pre-wrap" data-node-id="341:3678">{`Connexion `}</p>
          <div className="content-stretch flex flex-col gap-[30px] items-center justify-center relative shrink-0 w-full" data-name="Form" data-node-id="341:3679">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Textfield" data-node-id="341:3686">
              ...
              <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Helptext" data-node-id="341:3689">
                ...
                <Link to="/forgot-password" className="font-normal leading-[1.4] not-italic relative shrink-0 text-[#0ca99a] text-[12px] w-full whitespace-pre-wrap hover:underline" data-node-id="341:3693">
                  Mot de passe oublié ?
                </Link>
              </div>
            </div>
            ...
            {/* Sign up link */}
            <Link to="/register" className="block cursor-pointer font-normal leading-[0] not-italic relative shrink-0 text-[#121212] text-[0px] whitespace-nowrap hover:opacity-80" data-node-id="341:3698">
              <p className="leading-[1.4] text-[15px]">
                ...
                <span className="font-semibold text-[#0ca99a] hover:underline">Inscrivez-vous ici</span>
              </p>
            </Link>
          </div>
        </div>
